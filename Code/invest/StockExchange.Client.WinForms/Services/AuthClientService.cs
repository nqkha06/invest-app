...
public class AuthClientService
{
    ...
    public Task<bool> AdminDeleteUserAsync(
        long userId,
        CancellationToken cancellationToken = default)
    {
        return _connection.SendAsync<UserDeleteRequestDto, bool>(
            MessageType.AdminDeleteUser,
            new UserDeleteRequestDto { UserId = userId },
            cancellationToken);
    }
}
